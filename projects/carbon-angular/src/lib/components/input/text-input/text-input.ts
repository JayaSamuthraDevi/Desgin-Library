import { Component, signal, WritableSignal, forwardRef, HostBinding, Input } from '@angular/core';
...
export class TextInputComponent implements ControlValueAccessor {
  ...
  invalidText: WritableSignal<string> = signal('');
  warnText: WritableSignal<string> = signal('');
  ...
  /** Inputs to set signals from Storybook / external binding */
  ...
  @Input() set _invalidText(val: string) { this.invalidText.set(val); }
  @Input() set _warnText(val: string) { this.warnText.set(val); }
  ...
  @HostBinding('class.cds--text-input-wrapper') hostWrapper = true;
  @HostBinding('class.cds--text-input--fluid') get fluidClass() { return this.fluid() && !this.skeleton(); }
  @HostBinding('class.cds--text-input--fluid__skeleton') get fluidSkeletonClass() { return this.fluid() && this.skeleton(); }
  @HostBinding('class.cds--text-input--light') get lightClass() { return this.lightTheme(); }
  @HostBinding('class.cds--text-input--disabled') get disabledClass() { return this.disabled(); }
}
